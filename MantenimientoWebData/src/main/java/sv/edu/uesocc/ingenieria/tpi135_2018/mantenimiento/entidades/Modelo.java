 ...
 */
@Entity
@Table(name = "modelo", catalog = "mantenimientodb", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Modelo.findByNombreLike", query = "SELECT m FROM Modelo m WHERE LOWER(m.nombre) LIKE CONCAT('%',LOWER(\"n\"),'%') ")
