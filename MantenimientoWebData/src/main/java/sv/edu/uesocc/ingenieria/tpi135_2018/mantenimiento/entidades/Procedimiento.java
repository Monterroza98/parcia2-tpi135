 ...
 */
@Entity
@Table(name = "procedimiento", catalog = "mantenimientodb", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Procedimiento.findByNombreLike", query = "SELECT m FROM Procedimiento m WHERE LOWER(m.nombre) LIKE CONCAT('%',LOWER(\"n\"),'%') ")
