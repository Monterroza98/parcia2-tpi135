 ...
 */
@Entity
@Table(name = "unidad", catalog = "mantenimientodb", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Unidad.findByNombreLike", query = "SELECT m FROM Unidad m WHERE LOWER(m.nombre) LIKE CONCAT('%',LOWER(\"n\"),'%') ")
