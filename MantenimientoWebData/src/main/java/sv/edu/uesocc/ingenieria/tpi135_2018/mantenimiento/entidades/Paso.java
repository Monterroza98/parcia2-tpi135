 ...
 */
@Entity
@Table(name = "paso", catalog = "mantenimientodb", schema = "public")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "Paso.findByNombreLike", query = "SELECT m FROM Paso m WHERE LOWER(m.nombre) LIKE CONCAT('%',LOWER(\"n\"),'%') ")
